...
const DropdownMenu = props => {
  const { handleDesktopDropdownToggle, showDesktopDropdown, handleSignOut, user } = props;
  const placeholderProfileImg = 'images/placeholder-profile-image.jpeg';
    ...
    <div>
      <button onClick={handleDesktopDropdownToggle}
        ...
        <img className="object-cover w-7 h-7 rounded-full border border-gray-300
          ...
          src={user.profilePhotoUrl || placeholderProfileImg} />
        <ChevronDownIcon />
      </button>
      {showDesktopDropdown && (
